...
from data_models import DesignNode, DesignState, SingleProposal
...
def validate_dsg(dsg: DesignState) -> tuple[bool, str]:
    ...
    edge_set = {tuple(edge) for edge in dsg.edges}
...
def sanitize_dsg(dsg: DesignState) -> DesignState | None:
    """
