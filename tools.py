...
from data_models import DesignState, State
...
def arxiv_search_tool(query: Annotated[str, "The search query string for Arxiv papers."]) -> str:
    """
    ...
    try:
        ...
        return f"Error during Arxiv search: {e!s}"
...
def add_node_tool(state: State, node_info: dict, edges_to_add: list[tuple[str, str]] | None = None) -> str:
    """
